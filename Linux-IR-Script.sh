#
echo -e "###  Script for gathering Linux system artifacts for Digital Forensics and Incidence Response activities  ###"
...
echo -e "\n">>Lin-IR-output.txt 2>/dev/null
#
echo -e "############  Last reboot  ############" >>Lin-IR-output.txt 2>/dev/null
last reboot >>Lin-IR-output.txt 2>/dev/null
echo -e "\n">>Lin-IR-output.txt 2>/dev/null
#
...
echo -e "\n">>Lin-IR-output.txt 2>/dev/null
echo -e "############ Files created in last 2 days in tmp directory ############" >>Lin-IR-output.txt 2>/dev/null
find / tmp -ctime -2>>Lin-IR-output.txt 2>/dev/null
echo -e "\n">>Lin-IR-output.txt 2>/dev/null
...
echo -e "\n">>Lin-IR-output.txt 2>/dev/null
echo -e "############  Files created in last 2 days in home directory ############" >>Lin-IR-output.txt 2>/dev/null
find / home -ctime -2>>Lin-IR-output.txt 2>/dev/null
echo -e "\n">>Lin-IR-output.txt 2>/dev/null
...
echo -e "\n">>Lin-IR-output.txt 2>/dev/null
echo -e "############  Files created in last 1 days in root directory ############" >>Lin-IR-output.txt 2>/dev/null
find / root -ctime -1>>Lin-IR-output.txt 2>/dev/null
echo -e "\n">>Lin-IR-output.txt 2>/dev/null
#
